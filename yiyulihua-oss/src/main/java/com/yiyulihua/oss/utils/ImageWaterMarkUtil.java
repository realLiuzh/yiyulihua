...
public class ImageWaterMarkUtil {
     ...
     */
    public static BufferedImage addFullTextWaterMark(InputStream inputStream, String waterMarkContent) {
        return addWaterMark(inputStream, waterMarkContent, null, suffix, degree, alpha, true);
    }
     ...
     * @description 给图片增加文本水印铺满
     */
    public static BufferedImage addFullTextWaterMark(InputStream inputStream, String waterMarkContent, String fileExt) {
        return addWaterMark(inputStream, waterMarkContent, null, fileExt, degree, alpha, true);
    }
     ...
     */
    public static BufferedImage addFullImgWaterMark(InputStream inputStream, String watermarkPath) {
        return addWaterMark(inputStream, null, watermarkPath, suffix, degree, alpha, false);
    }
     ...
     * @description 给图片增加图片水印铺满
     */
    public static BufferedImage addFullImgWaterMark(InputStream inputStream, String watermarkPath, String fileExt) {
        return addWaterMark(inputStream, null, watermarkPath, fileExt, degree, alpha, false);
    }
     ...
     */
    private static BufferedImage addWaterMark(InputStream inputStream, String waterMarkContent, String watermarkPath, String fileExt, Integer degreeAngle, float transparency, boolean isText) {
        long startTime = System.currentTimeMillis();
        BufferedImage bufferedImage = null;
        ByteArrayOutputStream outputStream = new ByteArrayOutputStream();
        //水印字体，大小
